  ...
  const loadAnswers = (e) => {
    ...
    props.pilot_answers.map((item, index) => {
        if (item["itemID"] == item_id) {
            ...
            TF_answer.id = "TFanswer-"+index
            let OE_answer = document.createElement("div")
            OE_answer.id = "OEanswer-"+index
            text_answers_container.appendChild(TF_answer)
